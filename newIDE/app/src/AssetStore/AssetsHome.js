...
const getCategoryColumns = (windowSize: WindowSizeType, isLandscape: boolean) => {
  switch (windowSize) {
    case 'small':
...
const getShopItemsColumns = (windowSize: WindowSizeType, isLandscape: boolean) => {
  switch (windowSize) {
    case 'small':
...
export const AssetsHome = React.forwardRef<Props, AssetsHomeInterface>(
  (
    ...
    const { receivedAssetPacks, receivedGameTemplates } = useContext(AuthenticatedUserContext);
        ...
        <Line alignItems="center">
          {isLoading ? (
            <div style={styles.loaderContainer}>
              <PlaceHolderLoader />  {/* Display PlaceHolderLoader in the center of the screen */}
            </div>
          ) : (
